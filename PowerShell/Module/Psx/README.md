...
For a detailed understanding of the commands, you are redirected to the `PowerShell` inline help that provides a comprehensive documentation. For the `PowerShell` newbies, you can get a list of all the commands available via the following `PowerShell` command:
