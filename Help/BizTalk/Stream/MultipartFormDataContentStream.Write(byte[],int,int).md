...
## MultipartFormDataContentStream.Write(byte[], int, int) Method
...
<a name='Be.Stateless.BizTalk.Stream.MultipartFormDataContentStream.Write(byte[],int,int).buffer'></a>
...
<a name='Be.Stateless.BizTalk.Stream.MultipartFormDataContentStream.Write(byte[],int,int).offset'></a>

`offset` [System.Int32](https://docs.microsoft.com/en-us/dotnet/api/System.Int32 'System.Int32')

<a name='Be.Stateless.BizTalk.Stream.MultipartFormDataContentStream.Write(byte[],int,int).count'></a>
