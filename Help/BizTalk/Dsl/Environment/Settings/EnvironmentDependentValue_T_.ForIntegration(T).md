...
## EnvironmentDependentValue<T>.ForIntegration(T) Method

```csharp
public Be.Stateless.BizTalk.Install.EnvironmentDependentValue<T> ForIntegration(T value);
```
#### Parameters

<a name='Be.Stateless.BizTalk.Install.EnvironmentDependentValue_T_.ForIntegration(T).value'></a>
