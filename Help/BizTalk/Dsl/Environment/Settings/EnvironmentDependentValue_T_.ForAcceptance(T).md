...
## EnvironmentDependentValue<T>.ForAcceptance(T) Method

```csharp
public Be.Stateless.BizTalk.Install.EnvironmentDependentValue<T> ForAcceptance(T value);
```
#### Parameters

<a name='Be.Stateless.BizTalk.Install.EnvironmentDependentValue_T_.ForAcceptance(T).value'></a>
