...
## WcfBasicHttpAdapter.Outbound.ProxyUserName Property
...
WCF-BasicHttp adapter does not use the credential specified in the [ProxyUserName](WcfBasicHttpAdapter.Outbound.ProxyUserName.md 'Be.Stateless.BizTalk.Dsl.Binding.Adapter.WcfBasicHttpAdapter.Outbound.ProxyUserName') and [ProxyPassword](WcfBasicHttpAdapter.Outbound.ProxyPassword.md 'Be.Stateless.BizTalk.Dsl.Binding.Adapter.WcfBasicHttpAdapter.Outbound.ProxyPassword') properties for authentication against the proxy.
