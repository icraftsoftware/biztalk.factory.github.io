...
## ProtocolTypeExtensions.RequiresIsolatedHostForReceiveHandler(this ProtocolType) Method

Adapter's receive handler of adapter requires an isolated host.

```csharp
public static bool RequiresIsolatedHostForReceiveHandler(this Microsoft.BizTalk.Deployment.Binding.ProtocolType protocolType);
```
#### Parameters

<a name='Be.Stateless.BizTalk.Dsl.Binding.Adapter.Extensions.ProtocolTypeExtensions.RequiresIsolatedHostForReceiveHandler(thisMicrosoft.BizTalk.Deployment.Binding.ProtocolType).protocolType'></a>
