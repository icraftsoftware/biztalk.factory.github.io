...
## BizTalkFactorySubscribablePropertiesExtensions.SetReceiverName(this IBaseMessage, string) Method

```csharp
public static Microsoft.BizTalk.Message.Interop.IBaseMessage SetReceiverName(this Microsoft.BizTalk.Message.Interop.IBaseMessage message, string receiverName);
```
#### Parameters

<a name='Be.Stateless.BizTalk.ContextProperties.Extensions.BizTalkFactorySubscribablePropertiesExtensions.SetReceiverName(thisMicrosoft.BizTalk.Message.Interop.IBaseMessage,string).message'></a>
...
<a name='Be.Stateless.BizTalk.ContextProperties.Extensions.BizTalkFactorySubscribablePropertiesExtensions.SetReceiverName(thisMicrosoft.BizTalk.Message.Interop.IBaseMessage,string).receiverName'></a>
