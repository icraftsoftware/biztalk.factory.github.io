#### [Be.Stateless.BizTalk.Pipeline.Components.XUnit](README.md 'README')
...
## PipelineComponentFixture<T>.ExecuteCoreIsSkippedWhenPipelineComponentIsNotEnabled() Method
