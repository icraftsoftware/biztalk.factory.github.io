...
## BtsPropertiesExtensions.RouteMessageOnFailure(this IBaseMessage) Method

```csharp
public static Microsoft.BizTalk.Message.Interop.IBaseMessage RouteMessageOnFailure(this Microsoft.BizTalk.Message.Interop.IBaseMessage message);
```
#### Parameters

<a name='Be.Stateless.BizTalk.ContextProperties.Extensions.BtsPropertiesExtensions.RouteMessageOnFailure(thisMicrosoft.BizTalk.Message.Interop.IBaseMessage).message'></a>
