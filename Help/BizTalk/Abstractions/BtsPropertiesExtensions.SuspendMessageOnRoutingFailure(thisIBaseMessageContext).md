...
## BtsPropertiesExtensions.SuspendMessageOnRoutingFailure(this IBaseMessageContext) Method

```csharp
public static Microsoft.BizTalk.Message.Interop.IBaseMessageContext SuspendMessageOnRoutingFailure(this Microsoft.BizTalk.Message.Interop.IBaseMessageContext context);
```
#### Parameters

<a name='Be.Stateless.BizTalk.ContextProperties.Extensions.BtsPropertiesExtensions.SuspendMessageOnRoutingFailure(thisMicrosoft.BizTalk.Message.Interop.IBaseMessageContext).context'></a>
