...
## BtsPropertiesExtensions.EnableDynamicSend(this IBaseMessageContext) Method

```csharp
public static Microsoft.BizTalk.Message.Interop.IBaseMessageContext EnableDynamicSend(this Microsoft.BizTalk.Message.Interop.IBaseMessageContext context);
```
#### Parameters

<a name='Be.Stateless.BizTalk.ContextProperties.Extensions.BtsPropertiesExtensions.EnableDynamicSend(thisMicrosoft.BizTalk.Message.Interop.IBaseMessageContext).context'></a>
