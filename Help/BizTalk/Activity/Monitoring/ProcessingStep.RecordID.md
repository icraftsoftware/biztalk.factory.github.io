...
## ProcessingStep.RecordID Property

```csharp
public System.Nullable<long> RecordID { get; set; }
```

Implements [RecordID](IActivity.RecordID.md 'Be.Stateless.BizTalk.Activity.Monitoring.Model.IActivity.RecordID')
