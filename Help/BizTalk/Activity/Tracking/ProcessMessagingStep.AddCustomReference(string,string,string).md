...
## ProcessMessagingStep.AddCustomReference(string, string, string) Method
...
<a name='Be.Stateless.BizTalk.Activity.Tracking.Messaging.ProcessMessagingStep.AddCustomReference(string,string,string).referenceType'></a>
...
<a name='Be.Stateless.BizTalk.Activity.Tracking.Messaging.ProcessMessagingStep.AddCustomReference(string,string,string).referenceName'></a>
...
<a name='Be.Stateless.BizTalk.Activity.Tracking.Messaging.ProcessMessagingStep.AddCustomReference(string,string,string).referenceData'></a>
