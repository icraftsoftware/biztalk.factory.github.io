...
## MessagingStep.AddCustomReference(string, string, string, string) Method
...
<a name='Be.Stateless.BizTalk.Activity.Tracking.Messaging.MessagingStep.AddCustomReference(string,string,string,string).referenceType'></a>
...
<a name='Be.Stateless.BizTalk.Activity.Tracking.Messaging.MessagingStep.AddCustomReference(string,string,string,string).referenceName'></a>
...
<a name='Be.Stateless.BizTalk.Activity.Tracking.Messaging.MessagingStep.AddCustomReference(string,string,string,string).referenceData'></a>
...
<a name='Be.Stateless.BizTalk.Activity.Tracking.Messaging.MessagingStep.AddCustomReference(string,string,string,string).longReferenceData'></a>
