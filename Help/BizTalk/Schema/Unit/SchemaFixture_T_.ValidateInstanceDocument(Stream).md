...
## SchemaFixture<T>.ValidateInstanceDocument(Stream) Method
...
```csharp
protected System.Xml.XmlDocument ValidateInstanceDocument(System.IO.Stream stream);
```
#### Parameters

<a name='Be.Stateless.BizTalk.Unit.Schema.SchemaFixture_T_.ValidateInstanceDocument(System.IO.Stream).stream'></a>
